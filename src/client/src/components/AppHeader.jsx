...
export default function AppHeader() {
  ...
  const calendarEnabled = !!activeBoard.enable_calendar
  ...
  return (
    <header className="border-b border-border px-4 md:px-6 py-3 flex items-center gap-4 md:gap-6">
      ...
      <div className="flex items-center gap-4 mr-auto">
        <h1 className="hidden md:flex items-center gap-2 text-lg font-heading font-semibold text-foreground tracking-tight">

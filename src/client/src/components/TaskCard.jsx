 ...
 * @param {{ task: Object, onClick: Function, onComplete: Function, onDelete: Function, overlay?: boolean }} props
 */
export default function TaskCard({ task, onClick, onComplete, onDelete, overlay = false }) {
  const {
